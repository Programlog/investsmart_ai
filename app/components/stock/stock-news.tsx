    ...
    return (
        <Card>
            <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle>Recent News: {symbol}</CardTitle>
            ...
            <CardContent>
                ...
                >
                    <TabsList className="mb-4">
                        ...
                        <TabsTrigger value="filing">SEC Filings</TabsTrigger>
                    </TabsList>
                            ...
                            {newsItems.length > 0 ? (
                                newsItems.map((item) => (
                                    <div key={item.id} className="border-b pb-4 last:border-0 last:pb-0">
                                        <h3 className="font-medium hover:underline cursor-pointer mb-1">{item.title}</h3>
